...
Verifies that an implemented ticket matches its acceptance criteria. Run this after the [implement](../implement/) skill completes a ticket.
...
**Use the [test-cli](../test-cli/) skill for these - NEVER raw tmux or blocking bash.**
