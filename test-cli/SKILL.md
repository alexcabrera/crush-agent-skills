---
name: test-cli
description: Run automated tests for CLI applications, TUIs, and long-running processes using tmux isolation. Use when testing command-line tools, terminal UIs, interactive CLIs, or any application that runs in a terminal. For web applications, use the test-web skill instead.
license: MIT
...
Run automated tests for CLI applications, TUIs, and long-running processes in isolated tmux sessions.
