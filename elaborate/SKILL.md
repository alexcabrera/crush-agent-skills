---
name: elaborate
description: Transforms rough ideas into detailed design documents through iterative requirements clarification, research, and and architecture design. Use when starting with a vague concept, exploring a new feature, or or when requirements need clarification. Outputs specs that feed into plan skill for decomposition.
license: MIT
...
Part of the agent-skills collection. See [shared/workflow.md](../shared/workflow.md) for the full workflow.
